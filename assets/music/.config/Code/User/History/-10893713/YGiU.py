...
class PlayerEntryScreen(QWidget):
    ...
    def keyPressEvent(self, event: QKeyEvent):
        ...
        # Handler for the Enter key press
            ...
            print(self.red_row[0][2].hasFocus())
            print(self.red_row[0][3].hasFocus())
            print(self.red_row[0][4].hasFocus())

            # self.enter_handler(field, field2, field3, player_num, team, state)
    ...
    def enter_handler(self, field, field2, field3, player_num, team, state):
